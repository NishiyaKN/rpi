...
def update_price_history():
    products = load_json_file('mercadolivre-products.json')
    if not products:
        print("❌ No products found in mercadolivre-products.json")
        return
        
    price_history = load_json_file('mercadolivre-prices.json')
    ...
    if updated:
        with open('mercadolivre-prices.json', 'w', encoding='utf-8') as f:
